...
def tester(model, param1xl, param1xu, param2xl, param2xu):
    ...
    for i in range(4):
        ...
        for j in range(param1xl, param1xu + 1):
            ...
            for k in range(param2xl, param2xu + 1):
                ...
                image = torch.rand(batch_size, channels, height, width).cuda()
                enc0_out, enc1_out, enc2_out, bottle, dec0_out, dec1_out, dec2_out, final = model(input, True)
